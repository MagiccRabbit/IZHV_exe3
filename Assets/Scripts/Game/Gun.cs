...
public class Gun : MonoBehaviour
{
    ...
    public void ShootGun(Transform director)
    {
        ...
        {
            SpawnBullet(
                director.position,director.rotation
            );
        }
        else
        {
            ...
            {
                Vector3 pos;
                pos.x = director.position.x;
                pos.y = director.position.y;
                pos.z = director.position.z;
                Quaternion rotate = director.rotation;
                rotate *= Quaternion.Euler(Vector3.forward * (20 *i));
                SpawnBullet(director.position,rotate);
            }
        }
    }
